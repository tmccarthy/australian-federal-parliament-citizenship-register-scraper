...
object TestAllSenateStatementInRelationToCitizenshipScraping extends MuckingWithDynamoMain {
        ...
        fs2.Stream
          ...
          .parEvalMap(maxConcurrent = 4) { documentReference =>
            friendlyClient
              ...
              .attempt
              .flatMap {
                case Right(parsedStatement) => IO(logger.info(s"${documentReference.senatorName} => $parsedStatement"))
